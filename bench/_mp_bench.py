...
def main():
    ctx = GameContext(game_id="KC_NYJ", home="KC", away="NYJ", spread_line=(-3.0, 3.0), season_epa=(1, -1))
    games = {"KC_NYJ": ctx}
    ...
    for n, workers, chunk in configs:
        ...
        print(f"n={n:>5}  workers={workers:>2}  chunks={n_chunks:>2}  time={elapsed:.3f}s  sims/sec={sps:.0f}  ms/sim={elapsed/n*1000:.2f}")
